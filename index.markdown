...
<p class="reach-out">reach out — <a href="mailto:dinghao.luo@outlook.com">[dinghao.luo@outlook.com]</a></p>

I'm finishing my PhD at the [Max Planck Florida Institute for Neuroscience](https://www.mpfi.org) in December 2026, working on hippocampus, dopamine, and more.

<p class="page-nav">on this page: <a href="#science">science :)</a> · <a href="#writing">writing :)</a> · <a href="#brief-takes">brief takes :)</a> · <a href="#music">music :)</a> · <a href="#photos">photos :)</a> · <a href="#other-stuff">other stuff :)</a></p>
