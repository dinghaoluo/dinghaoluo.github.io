...
Do not let transitional prose lie about the essay's actual route. If a movement begins from an image, object, or bodily shock, do not later describe it as though it began from the abstraction that followed. Name the real transformation.
...
Introduce outside critics and theorists as people before they become shorthand. First mention usually needs the full name and, for major books, the publication year. Their vocabulary should enter after the essay has created the problem it solves, not as a prefabricated frame placed over the work.
...
Conceptual links from Dinghao's own thoughts entries are high-value when logically bridged. Treat earlier entries as a vocabulary reservoir, not as authority. A borrowed phrase should become a hinge inside the current argument; do not import nearby ideas merely because they are personally relatable.
