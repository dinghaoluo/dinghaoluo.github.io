...
excerpt: "Walking Castle Hill after work with Radiohead in the earphones, and the difference between being left alone and being free."
image: /assets/images/personal/two-freedoms.webp
feature_banner: true
banner_image: "/assets/images/personal/two-freedoms-cambridge-dusk.jpg"
banner_image_alt: "Cambridge cityscape at dusk with church tower and rooftops"
...
{% include figure image_path="/assets/images/personal/two-freedoms-tree-shadow.jpg" alt="Tree branches casting shadows on a brick wall in autumn light" caption="shadows on brick, late afternoon" class="writing-insert writing-insert--right writing-insert--small" %}
...
{% include figure image_path="/assets/images/personal/two-freedoms-train-platform.jpg" alt="Two figures running on a train platform at dusk" caption="platform, motion" class="writing-insert writing-insert--left writing-insert--small" %}
...
*Originally published in Chinese as 「[兩種自由](https://mp.weixin.qq.com/s/0igKd0PNqmrCsfIGHoTFfA)」 on 阿莫東森的無聊生活.*
{: .source-note}
