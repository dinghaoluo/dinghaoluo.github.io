...
<span class="dropcap">W</span>**orking memory** is the cognitive system responsible for the temporary storage and online manipulation of information. If you have ever held a phone number in your head just long enough to dial it, that was working memory doing the work. In a modern world saturated with stimuli, the execution of complex cognitive tasks depends heavily on it. Its capacity is therefore a key index of cognitive ability, and one of the most important open problems in cognitive psychology.
