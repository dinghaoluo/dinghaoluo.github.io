...
excerpt: "A visit to Shanwei for the shark meat and Lighthouse Island, and the sea that will not change."
...
{% include figure image_path="/assets/images/personal/shanwei-lighthouse-island.webp" alt="Lighthouse Island in Red Bay seen from a speedboat, the white lighthouse rising from a green slope." caption="Lighthouse Island, Red Bay" class="writing-insert writing-insert--right" %}
...
{% include figure image_path="/assets/images/personal/shanwei-window-to-sea.jpg" alt="The South China Sea framed by the empty window of an abandoned brick building on the Shanwei coast." caption="an old fortress on the island has a window overlooking the surrounding sea" class="writing-insert writing-insert--left writing-insert--small" %}
...
*Originally published in Chinese as 「[汕尾](https://mp.weixin.qq.com/s/rfbpbfc0f3QyMcz7vRYq9w)」 on 阿莫東森的無聊生活.*
{: .source-note}
