...
title_display: "Racing towards a Grand Theory of Consciousness"
...
excerpt: "From Crick's second revolution through Chalmers' hard problem to the Templeton adversarial collaborations, and what happened when the results came in."
...
The most prominent rival to IIT is [Global Neuronal Workspace](https://doi.org/10.1016/j.neuron.2020.01.026) theory, or GNW. Its roots are older than IIT's. In 1988, the psychologist Bernard Baars at the Wright Institute in California proposed [Global Workspace Theory](https://doi.org/10.1017/S0140525X00047221), borrowing a concept from artificial intelligence: specialised processing modules in the brain (vision, language, memory, motor planning) operate independently and in parallel, but when information needs to be shared across modules for a complex task, it is broadcast to a 'global workspace', a kind of cognitive blackboard visible to all.
...
{% include figure image_path="/assets/images/writing/arc-francis-crick-salk.jpg" alt="Francis Crick in his office at the Salk Institute, with a model of the human brain behind him — inherited from Jacob Bronowski." caption="Francis Crick in his office at the Salk Institute, with a model of the human brain inherited from Jacob Bronowski. The brain model and the man who kept it summarise the programme: start from the physical object and work upward. Photograph by Marc Lieberman, [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Francis_Crick_crop.jpg), CC BY 2.5." class="writing-insert writing-insert--section writing-insert--right" %}

The problem, by 2019, was that the theories had been arguing past each other for decades. IIT, GNW, HOT, and several others had each accumulated supporting evidence, refined their predictions, and built loyal research communities — but they had rarely been tested against each other using the same experimental paradigms, the same stimuli, the same participants. Each laboratory tested its own theory on its own terms. The result was a field rich in theories and poor in arbitration.

In 2019, the [Templeton World Charity Foundation](https://www.templetonworldcharity.org/our-priorities/discovery/accelerating-research-consciousness) launched a $20 million initiative called Accelerating Research on Consciousness, or ARC. The concept was 'adversarial collaboration': bring proponents of competing theories to the same table, force them to preregister opposing predictions derived from their theories, then test those predictions using the same experimental design, the same data, and independent judges.
...
> If the theories were not answering the same question,<br>
> testing them against each other might produce a winner<br>
...
ARC launched five adversarial collaborations testing eight theories in total. The first and largest was [COGITATE](https://doi.org/10.1038/s41586-025-08888-1).
...
Two months before COGITATE published, the most public moment in the adversarial collaboration's history had already occurred — not in a laboratory but on a stage. On 23 June 2023, at the [26th annual meeting of the Association for the Scientific Study of Consciousness](https://www.nature.com/articles/d41586-023-02120-8) in New York City, Christof Koch conceded a bet.

{% include figure image_path="/assets/images/writing/arc-christof-koch.jpg" alt="Christof Koch, neuroscientist." caption="Christof Koch. The bet he lost in 2023 had been made twenty-five years earlier in a bar in Bremen; the bet he made in its place will not be settled until 2048. Public domain, [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:ChristofKoch.jpg)." class="writing-insert writing-insert--section" %}
...
> The deepest disagreements in consciousness science<br>
...
ARC's second adversarial collaboration, [INTREPID](https://www.intrepid-arc.org/), is testing IIT against Predictive Processing and Cyriel Pennartz's neurorepresentationalism, using paradigms ranging from optogenetics in mice to visual scotoma experiments in humans. Its results, presented in preliminary form at a [September 2024 symposium in Glasgow](https://www.gla.ac.uk/), are expected to refine the picture further.
...
Interviews with Anil Seth, Cyriel Pennartz, Hakwan Lau, David Rosenthal, Dawid Potgieter, and Liu Ling were conducted for the original Chinese-language feature in *Scientific American* China, March 2021 print issue. The English revision draws on Crick and Koch's [1990 programme](https://doi.org/10.1016/0166-2236(90)90107-L) and Koch's account in [*The Quest for Consciousness*](https://www.worldcat.org/title/56194508) (2004); Chalmers' [formulation of the Hard Problem](https://consc.net/papers/facing.html) (1995); Tononi and Koch on IIT in [*Phil. Trans. R. Soc. B*](https://doi.org/10.1098/rstb.2014.0167) (2015); Mashour, Roelfsema, Changeux, and Dehaene on GNW in [*Neuron*](https://doi.org/10.1016/j.neuron.2020.01.026) (2020); Brown, Lau, and LeDoux on HOT in [*Trends Cogn. Sci.*](https://doi.org/10.1016/j.tics.2019.06.009) (2019); Casali et al. on PCI in [*Sci. Transl. Med.*](https://doi.org/10.1126/scitranslmed.3006294) (2013); the [COGITATE results in *Nature*](https://doi.org/10.1038/s41586-025-08888-1) (2025); *Nature*'s report on the [Koch–Chalmers bet](https://www.nature.com/articles/d41586-023-02120-8) (2023); and the [open letter on IIT](https://doi.org/10.31234/osf.io/zsr78) (2023). Aaronson's critique of IIT appeared on his [blog](https://scottaaronson.blog/?p=1799) (2014); Tononi's [response](https://doi.org/10.1186/s12868-014-0130-x) in *BMC Neuroscience* (2014). The [ARC initiative](https://www.templetonworldcharity.org/our-priorities/discovery/accelerating-research-consciousness) is funded by the Templeton World Charity Foundation.
</div>
