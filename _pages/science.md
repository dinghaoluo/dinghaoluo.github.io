...
The sections on this page are laid out in chronological order, but you can also [skip to my PhD project.](#current-project)
...
<figure class="writing-insert writing-insert--right">
  <img src="/assets/images/science/paulsen-lab-cambridge-2019.webp" alt="Paulsen Lab Christmas dinner, Cambridge, 2019" width="1200" height="900" loading="lazy">
...
I graduated from Cambridge in July 2020 and spent the next year at [<i>Scientific American</i> China in Beijing](/writing/) before starting my PhD. I arrived at the Max Planck Florida Institute for Neuroscience in May 2021.
...
I simulated the 'foraging-mouse-in-winter-snow' scenario mentioned above using a virtual reality set-up. We put an animal on a treadmill, and made it learn the location of a hidden reward (similar to how the food cache location is hidden from the navigating mouse in the snowfield). Each trial lasted around 5–10 seconds, and in order to obtain the reward successfully on a trial, the animal had to rely on its learned trial structure since the VR setting showed only a constant grey corridor without reward cues. In a sense, the mouse's task was to compare how far it had travelled (or how long it had run) to the trial structure in its memory, and to decide when to begin licking for reward. With this set-up, I was able to look into the qeustion of whether LC dopaminergic inputs modulated the mouse's accuracy of navigation.

### What we found

**LC activity marks the start of time/distance estimation.** A major subset of catecholaminergic locus coeruleus (LC) neurones bursts at trial-start run onset. The response is not explained by running speed alone, predicts first-lick timing on single trials, and optogenetic amplification delays reward-seeking without reducing running or reward rate. That single-trial specificity is one of the parts I find most striking: pushing a single moment of LC activity shifts when the animal begins its decision.

**The LC signal reaches CA1 as dopamine.** Local CA1 pharmacology points to D1-like dopamine receptors rather than alpha-1 or beta adrenergic receptors as the relevant pathway for task performance. Two-photon imaging with [dLight](https://doi.org/10.1126/science.aat4422), a genetically encoded dopamine sensor developed by Patriarchi, Tian, and colleagues, shows that LC activation and natural run onset both produce fast dopamine signals in CA1. The LC-to-hippocampus dopamine pathway is relatively new ([Takeuchi et al. 2016](https://doi.org/10.1038/nature19325) was among the first widely recognised demonstrations) and much of what the field knows about local dopamine dynamics comes from VTA studies. Seeing it from the LC side is why the project still feels fresh to me.
...
**A compact model reproduces the selectivity.** The model uses three inputs to a synthetic CA1 principal-neuron population: run-related input, reward-related input, and a phasic LC signal transformed into dopamine drive. The run and reward terms follow Raphael Heldman's [Nature Communications](https://doi.org/10.1038/s41467-025-67038-3) and [bioRxiv](https://doi.org/10.1101/2025.03.16.643530) models of CA1 principal-neuron dynamics; the new term is the LC-to-dopamine drive.
